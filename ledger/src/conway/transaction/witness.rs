...
pub struct Set<'a> {
    ...
    pub plutus_v2: Unique<Box<[&'a PlutusV2]>, false>,
    #[cbor(n(7), optional, decode_with = "unique::codec::NonEmpty<&'a PlutusV3>")]
    pub plutus_v3: Unique<Box<[&'a PlutusV3]>, false>,
}
