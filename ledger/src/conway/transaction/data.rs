...
pub struct Data<'a> {
    ...
    #[cbor(n(4), optional)]
    pub plutus_v3_scripts: Box<[&'a PlutusV3]>,
}
...
pub enum Error {
    ...
    /// while decoding babbage style data
...
pub(crate) mod codec {
    use crate::{
        allegra::Script, alonzo::script::PlutusV1, babbage::script::PlutusV2,
        conway::script::PlutusV3, shelley,
    };
