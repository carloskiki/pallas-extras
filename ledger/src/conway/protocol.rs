...
pub enum Parameter {
    ...
    AdaPerUtxoByte(Coin),
    #[n(18)]
    CostModels(#[cbor(with = "cost::model::Codec")] cost::Models),
    #[n(19)]
    ...
    #[n(25)]
    PoolVotingThresholds(voting::threshold::Pool),
    #[n(26)]
    DrepVotingThresholds(voting::threshold::DelegateRepresentative),
    #[n(27)]
    ...
    #[n(33)]
    ScriptReferenceCost(interval::Unsigned),
}
