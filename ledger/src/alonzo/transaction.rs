...
pub enum Error {
    ...
    /// in field `outputs`
    Outputs(#[from] container::Error<<output::Output<'static> as Decode<'static>>::Error>),
    /// in field `fee`
...
impl CborLen for Transaction<'_> {
...
impl<'a, 'b: 'a> Decode<'b> for Transaction<'a> {
