...
use crate::protocol::{Protocol, UnknownProtocol};
...
impl<P: Protocol> TryFrom<[u8; 8]> for Header<P> {
...
impl<P: Protocol> From<Header<P>> for [u8; 8] {
...
impl<P: Protocol> TryFrom<u16> for ProtocolNumber<P> {
    type Error = UnknownProtocol;
    ...
    fn try_from(value: u16) -> std::result::Result<Self, UnknownProtocol> {
        ...
        Ok(Self { server: responder, protocol })
    }
}

impl<P: Protocol> From<ProtocolNumber<P>> for u16 {
